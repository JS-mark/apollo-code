...
`VENDOR.toml`. Apollo's adapter stays dependency-minimal: the macOS base policy
is compiled into the binary, the Linux bundled-bwrap implementation is retained
as the audited reference for Apollo's digest adapter, and the Windows entrypoint
