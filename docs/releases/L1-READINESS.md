...
Checklist: `docs/superpowers/specs/2026-07-31-apollo-code-design/RELEASE-CHECKLIST-L1.md`
...
| Local escape fixture | Pass | `bash crates/apollo-sandbox/tests/escape/run.sh target/debug/apollo-sandbox`. |
...
| §9 build/distribution | Blocked | CLI uses multi-file `tsc`, not Rolldown `dist/apollo.js`; no `platforms/` packages or 12 optional native dependencies; no universal2 `lipo` job. |
