...
- Management commands such as `doctor`, `context`, `evolution`, `plugin`, and `mcp` keep a single JSON document followed by a newline. Arrays remain arrays and objects remain objects.
